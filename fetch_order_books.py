if __name__ == '__main__':
    ...
    date_from = datetime.datetime(2019, 1, 1, 0, 0, tzinfo=datetime.timezone.utc)
    date_to = datetime.datetime(2020, 1, 1, 0, 0, tzinfo=datetime.timezone.utc)
    start = time.time()
    ...
    print(elapsed_time)
    with open("./data/order_book/NZD_USD_OB_2019.json", "w") as f:
